	  ...
	  <script type="text/javascript">
		  $(function () {
			  $("#next").click(function () {
				  ...
				  location.href="/product?method=findAllBorrow&page="+page;
			  })
			  ...
			  $("#first").click(function () {
				  location.href="/product?method=findAllBorrow&page=1";
			  })

			  $("#last").click(function () {
				  var pages = parseInt($("#pages").html());
				  location.href="/product?method=findAllBorrow&page="+pages;
			  })
		  })
	  </script>
  </head>
    ...
    <%@ include file="top.jsp" %>
  	...
  	<div id="main">
		<div class="navigation">
				当前位置:&nbsp;&nbsp;<a href="/product?page=1">首页</a>
		...
		<table class="table" cellspacing="0">
			...
			<c:forEach items="${list}" var="borrow">
				<tr>
					...
					<td>${borrow.product.lessor}</td>
					<td>${borrow.product.manufacturer}</td>
					<td>${borrow.user.name}</td>
					<td>${borrow.user.tel}</td>
					<td>${borrow.user.cardId}</td>
